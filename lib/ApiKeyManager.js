...
class ApiKeyManager {
  ...
  // A method to store the key
  setKey(key) {
    this.config.set("apiKey", key);
  }

  // A method to handle the getKey and throw an error if the user try to see a key that wasn't registered yet
  getKey() {
